...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/npmulder/homelab/flux-diff.yaml?branch=main&label=flux-diff&style=for-the-badge)](https://github.com/npmulder/homelab/actions/workflows/flux-diff.yaml)
[![GitHub last commit](https://img.shields.io/github/last-commit/npmulder/homelab?color=purple&style=for-the-badge)](https://github.com/npmulder/homelab/commits/main)
[![GitHub repo size](https://img.shields.io/github/repo-size/npmulder/homelab?color=orange&style=for-the-badge)](https://github.com/npmulder/homelab)
